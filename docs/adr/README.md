...
| [0007](0007-langfuse-native-dimensions.md) | Map attribution to Langfuse native dimensions (tags/user/release/names) | Accepted |
...
- Changing the Langfuse reserved-key mapping / tag scheme (ADR 0007)
